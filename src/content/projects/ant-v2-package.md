...
summary: "An async Python client for the ANTCDE API whose data models generate themselves from the live Swagger spec via CI/CD."
order: 4
role: "Developer"
period: "CollaborAll"
...
For the CollaborAll project I wrote a second-generation Python package that talks to the ANTCDE API **asynchronously**.
