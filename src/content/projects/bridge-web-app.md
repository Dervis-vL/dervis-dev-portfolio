...
The backend is a **microservices architecture**: one service wraps the Traffic Bridge Tool, another estimates construction cost from the inputs, and a third calculates the Environmental Cost Indicator (MKI) score. The frontend surfaces cost and MKI in real time, and the app exchanges results with [ANT CDE](https://antcde.io/).
