...
So I built a small **Tkinter** GUI on top of **Selenium**: you enter your login, choose where to save, give it a batch number, and pick a single structure or the whole batch. One button press, and it downloads everything in the background while you do something more useful. Sit back and have a coffee!
